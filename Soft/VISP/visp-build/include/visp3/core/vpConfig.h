...
// ViSP minor version.
#define VISP_VERSION_MINOR 0

// ViSP patch version.
#define VISP_VERSION_PATCH 1

// ViSP version with dots "3.0.1".
#define VISP_VERSION 3.0.1
...
#  define VISP_HAVE_OPENCV_VERSION (2<<16 | 4<<8 | 9)
#endif
...
/* #undef VISP_HAVE_LAPACK_C */

// Defined the path to the basic scenes used by the simulator
#define VISP_SCENES_DIR "/home/force/Programmation/ESIR2/Soft/VISP/visp-build/data/wireframe-simulator;/usr/local/share/visp-3.0.1/data/wireframe-simulator"

// Defined the path to the robot's arms 3D model used by the robot simulators
#define VISP_ROBOT_ARMS_DIR "/home/force/Programmation/ESIR2/Soft/VISP/visp-build/data/robot-simulator;/usr/local/share/visp-3.0.1/data/robot-simulator"
